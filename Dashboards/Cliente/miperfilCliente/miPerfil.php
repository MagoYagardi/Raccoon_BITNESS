    ...
    if ($_SERVER['REQUEST_METHOD'] === 'GET') {
        ...
        if (!$user['ruta_perfil']) {
            if ($user['genero'] === 'Masculino') {
                $ruta_perfil = '/BITnessGYM/assets/imgGifCliente/default1.jpeg';
            } elseif ($user['genero'] === 'Femenino') {
                $ruta_perfil = '/BITnessGYM/assets/imgGifCliente/default2.jpg';
            } elseif ($user['genero'] === 'Prefiero no decirlo') {
                $ruta_perfil = '/BITnessGYM/assets/imgGifCliente/gnome.jpeg'; // Imagen predeterminada para "Prefiero no decirlo"
            } else {
                $ruta_perfil = '/BITnessGYM/assets/imgGifCliente/default1.jpeg'; // Valor predeterminado en caso de error
            }
        } else {
        ...
        if (isset($_FILES['foto_perfil']) && $_FILES['foto_perfil']['error'] === UPLOAD_ERR_OK) {
            ...
            $ruta_perfil = '/LA_POSTA/assets/imgGifCliente/' . $uniqueFileName;
